...
$faq = [
    ...
    [
        ...
        'answers' => [
            ...
            '<ol><li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:<ol class="list-letter"><li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li><li>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></ol></li><li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li></ol>',
            'Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.',
            '<h4>Stabilire il paese associato al tuo account</h4><br>Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell\'ultimo anno.',
    ...
    <main>
        <div class="container">
            <div class="main-content">
                <!-- Ciclo foreach scorre tutti gli elementi -->
                <!-- array: $faq e chiave: $questionAnswer -->
                <?php foreach ($faq as $questionAnswer) { ?>
                    <section>
                        <!-- faccio la stampa della question -->
                        <h2><?php echo $questionAnswer['question']; ?></h2>
                        <!-- creo un secondo ciclo foreach per scorrere tra le risposte -->
                        <!-- array: $questionAnswer['answers'] e chiave: $singleAnswer -->
                        <?php foreach ($questionAnswer['answers'] as $singleAnswer) { ?>
                            <div>
                                <!-- faccio la stampa della risposta -->
                                <?php echo $singleAnswer; ?>
                            </div>
                        <?php }; ?>
                        <!-- fine secondo ciclo foreach -->
                    </section>
                <?php }; ?>
                <!-- fine ciclo foreach -->
            </div>
